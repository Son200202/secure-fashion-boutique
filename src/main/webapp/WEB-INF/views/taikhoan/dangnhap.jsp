					...
					<div class="tab-pane fade show active" id="login-form"
						...
						<form:form action="dangnhap" method="post" id="form-login"
							...
							<a href="https://accounts.google.com/o/oauth2/auth?scope=email
									&redirect_uri=https://localhost:8443/shoes-store-manage/dangnhap-google
									&response_type=code
									&client_id=156124981875-bn59f8ictmk5liao23ipd4h2a7h9kt5d.apps.googleusercontent.com
